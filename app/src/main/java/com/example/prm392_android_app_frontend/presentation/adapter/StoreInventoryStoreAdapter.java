...
public class StoreInventoryStoreAdapter extends RecyclerView.Adapter<StoreInventoryStoreAdapter.StoreViewHolder> {
    ...
    public StoreInventoryStoreAdapter(OnStoreClickListener listener) {
